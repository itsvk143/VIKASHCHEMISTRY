...
const getCategoryStyle = (category) => {
  switch (category) {
    ...
    case 'Trigonometry & Vectors':
      return {
        icon: <FlaskConical className="w-5 h-5" />, // Just a different icon
        color: 'text-pink-400',
...
// --- MAIN COMPONENT ---
const JEE_ADVANCE_MATHS = () => {
  const [activeMainTab, setActiveMainTab] = useState(null);
  const activeSubject = "Maths";

  const currentChapters = mathsChapters;
  const currentResources = mathsResources;
                  ...
                  {activeMainTab === "IMPORTANT BOOK" ? (
                    <div className="space-y-8">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
                        {(() => {
                          const bookCategories = ["Algebra", "Calculus", "Coordinate Geometry", "Trigonometry & Vectors", "Other"];
...
export default JEE_ADVANCE_MATHS;
...
// --- MAIN COMPONENT ---
const JEE_ADVANCE_PHYSICS = () => {
  const [activeMainTab, setActiveMainTab] = useState(null);
  const activeSubject = "Physics";

  const currentChapters = physicsChapters;
  const currentResources = physicsResources;
                  ...
                  {activeMainTab === "IMPORTANT BOOK" ? (
                    <div className="space-y-8">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
                        {(() => {
                          const bookCategories = ["Mechanics", "Electrodynamics", "Modern Physics", "Optics & Waves", "Thermal Physics", "Other"];
...
export default JEE_ADVANCE_PHYSICS;
        ...
        <div className="min-h-screen bg-slate-50 py-12 px-4 sm:px-6 lg:px-8">
            ...
            >
                ...
                <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                    Explore the top entrance exams and premier engineering institutes in India to kickstart your journey in technology and innovation.
                </p>
            </motion.div>
            ...
            <div className="max-w-7xl mx-auto">
                <motion.h2
                    ...
                    className="text-3xl font-bold text-gray-800 mb-8 border-l-4 border-primary pl-4"
                >
                    Top 250 Engineering Colleges in India
                </motion.h2>
